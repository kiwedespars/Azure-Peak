...
/datum/supply_pack/rogue/iron_weapons/greatsword
	...
	cost = 50
	contains = list(/obj/item/rogueweapon/greatsword/iron)

/datum/supply_pack/rogue/iron_weapons/shortsword
	name = "Shortsword"
	cost = 25 // 1 Iron Ingot
	contains = list(/obj/item/rogueweapon/sword/short/iron)
...
/datum/supply_pack/rogue/iron_weapons/heavydagger
	...
	contains = list(/obj/item/rogueweapon/huntingknife/combat/iron)
...
/datum/supply_pack/rogue/iron_weapons/dory
	...
	contains = list(/obj/item/rogueweapon/spear/spellblade)
...
/datum/supply_pack/rogue/iron_weapons/flailalt
	name = "Flail, Studded"
	cost = 25 // 1 Iron Ingot
	contains = list(/obj/item/rogueweapon/flail/alt)
